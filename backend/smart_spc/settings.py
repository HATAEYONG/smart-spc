"""
Django settings for Smart SPC project.
"""
import os
...
WSGI_APPLICATION = 'smart_spc.wsgi.application'
...
if USE_SQLITE:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'smart_spc'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticatedOrReadOnly',  # 읽기는 허용
    ),
